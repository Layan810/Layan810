...
مشروع تدريبي يركّز على بناء نموذج تعلم آلي لتصنيف **أنواع الطقس** (مشمس، غائم، ممطر، مثلج) اعتمادًا على بيانات أرصاد جوية حقيقية.  

- 🤖 **استخدمت:** Python, Machine Learning, Pandas, Scikit-learn, Matplotlib, Seaborn  
- 📊 **الهدف:** تدريب نموذج قادر على التنبؤ بنوع الطقس اعتمادًا على العوامل المناخية (درجة الحرارة، الرطوبة، سرعة الرياح، الضغط الجوي، وغيرها).  
- 🧩 **النتيجة:** دقّة عالية بلغت **91.25%** في تصنيف الحالات الجوية.  
- 💡 **اقتراحات التحسين:** تجربة خوارزميات أكثر تقدمًا مثل XGBoost، وضبط المعاملات باستخدام GridSearchCV أو Cross-Validation.  
- 🔗 [View Repository](https://github.com/Layan810/Weather_Classification.git)
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-ffb6c1?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/layan-saeed)  
